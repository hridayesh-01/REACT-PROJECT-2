  ...
  return (
    <section id="services" className="services">
      ...
      <ul>
        ...
        <li>Retirement Planning: Ensuring a secure and comfortable retirement for you.</li>
        <li>Tax Advisory: Optimizing your tax strategies to maximize your savings.</li>
      </ul>
    </section>
  );
}
